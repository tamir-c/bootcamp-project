...
import travelSVG from "../../../public/assets/travel.svg";
        ...
        <div className="max-w-screen-xl:m-10 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            <div className="flex justify-center">
              <Image src={sky} alt="Sky Logo" width={200} />
            </div>
            <div className="mt-12 flex flex-col items-center">
              <h1 className="text-2xl xl:text-3xl font-extrabold">
                Sign up for Sky Travel!
              </h1>
          ...
          <div className="m-8 xl:m-16 w-full bg-contain bg-no-repeat flex ">
            <Image src={travelSVG} alt="Travel SVG" width={1500} />
          </div>
        </div> */}
        </div>
      </div>
